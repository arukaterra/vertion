...
class usersAuth {
	...
	function doRegister(){
		...
		$sql ="
		INSERT INTO {$DATABASE['MAJOR']}.`_user_profile` ( `userid`, `name`, `lastname`, `nickname`, `email`, `birthday`, `gender`, `liveat`, `username`, `createddate`, `modifieddate`, `nstatus`) 
		VALUES (  '{$userid}', '{$username}', '', '{$username}', '{$email}', '{$birthday}', '{$gender}', '0', '{$username}', '{$createdDate}',  '{$createdDate}', '{$nstatus}')";
